...
{
    [Activity(Label = "Vehicle Details")]
    public class VehicleDetailsActivity : BaseActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            try
            {
                ...
                var makes = dataManager.GetVehicleMake();

                //create adapters for the spinners
                var yearAdapter = new ArrayAdapter<string>(this, Android.Resource.Layout.SimpleSpinnerDropDownItem,
                    HelperClass.ListYears);
                var makesAdapter = new ArrayAdapter<string>(this, Android.Resource.Layout.SimpleSpinnerDropDownItem,
                    makes);
                ...
                //messageowner clicked
                _btnMessageOwner.Click += BtnMessageOwnerClicked;
        ...
        private void BtnMessageOwnerClicked(object sender, EventArgs e)
        {
            var username = HelperClass.LoggedInUser;
            var recipient = _lblOwnerName.Text;
        ...
        protected override async void OnResume()
        {
            ...
            try
            {
                if (IsPurchaseRequired())
                {
                    ...
                    Toast.MakeText(this, string.Format("You need to pay ${0} to view vehicle details", _amountToPay),
                                ...
                                _imageLoader.LoadImage(
                                    ...
                                    new ImageLoadingListener(
                                        ...
                                        loadingFailed: (imageUri, view, failReason) =>
                                        {
                                            ...
                                            {
                                                var message = string.Format("Error loading image {0}{1}", ex.Message,
                                                    ex.StackTrace);
