...
namespace liquidtorque.Fragments
{
    public class HomePageFragment : Fragment
    {
        ...
        {
            var homePageFragment = new HomePageFragment {Arguments = new Bundle()};
        ...
        public override async void OnStart()
        {
            ...
            if (_filterEnabled)
            {
                ...
                //load the vehicles
                await LoadAllVehicles(); //callthe network stuff
            }
        }
        ...
        private async Task<bool> LoadAllVehicles(bool refreshDataFromNetwork = false)
        {
            try
            {
                AndHUD.Shared.Show(Context, "Loading vehicles", -1, MaskType.Black);
